...
performAction: function parser__PerformAction(yyloc, yystate /* action[1] */, yysp, yyvstack, yylstack) {
          ...
          switch (yystate) {
case 0:
    /*! Production::    $accept : programa $end */
...
case 1:
    /*! Production::    programa : blocos EOF */
    ...
    this.$ = new ProgramNode(yyvstack[yysp - 1], location(yylstack[yysp - 1], yylstack[yysp]));
    return this.$;
    break;

case 2:
    /*! Production::    blocos : blocos bloco */
...
case 3:
    /*! Production::    blocos : bloco */
case 6:
    /*! Production::    sentencas : sentenca */
case 7:
    /*! Production::    sentenca : comando */
...
case 4:
    /*! Production::    bloco : sentencas PONTO */
    ...
    this.$ = new BlocoStatementNode(yyvstack[yysp - 1], location(yylstack[yysp - 1], yylstack[yysp]));
    break;

case 5:
    /*! Production::    sentencas : sentenca VIRGULA sentencas */
    ...
    this.$ = merge(yyvstack[yysp - 2], yyvstack[yysp]);
    break;

case 8:
    /*! Production::    comando : MOVER_ESQUERDA */
    ...
    this.$ = new MoverParaEsquerdaStatementNode();
    break;

case 9:
    /*! Production::    comando : MOVER_DIREITA */
    ...
    this.$ = new MoverParaDireitaStatementNode();
    break;
...
EOF: 1,
    ...
    simpleCaseActionClusters: {
      ...
      /*! Conditions:: INITIAL */
      /*! Rule::       mover para esquerda */
      5: 5,

      /*! Conditions:: INITIAL */
      /*! Rule::       mover para direita */
      6: 6,
      ...
      /*! Conditions:: INITIAL */
      /*! Rule::       <= */
      32: 'MENOR_OU_IGUAL_QUE',

      /*! Conditions:: INITIAL */
      /*! Rule::       >= */
      33: 'MAIOR_OU_IGUAL_QUE',
    ...
    rules: [
      ...
      /*  3: */  /^(?:[\\nr])/i,
      /*  4: */  /^(?:"[^"]")/i,
      /*  5: */  /^(?:mover para esquerda)/i,
      /*  6: */  /^(?:mover para direita)/i,
      /*  7: */  /^(?:se)/i,
      /*  8: */  /^(?:entao)/i,
      /*  9: */  /^(?:senao)/i,
      /* 10: */  /^(?:enquanto)/i,
