...
case 3:
    /*! Production::    comando : MOVER_PARA ponto */
...
case 4:
    /*! Production::    ponto : "(" numeros "," numeros ")" */

    this.$ = {
        nodeType: 'PONTO',
        value: [yyvstack[yysp - 3],yyvstack[yysp - 1]]
    };
    break;

case 5:
    /*! Production::    numeros : NUMERO */
...
EOF: 1,
    ...
    rules: [
      ...
      /* 38: */  /^(?:senao)/i,
      /* 39: */  /^(?::)/i,
      /* 40: */  /^(?:para contador de)/i,
      /* 41: */  /^(?:novo comando)/i,
      /* 42: */  /^(?:execultar comando)/i,
      /* 43: */  /^(?:ate)/i,
      /* 44: */  /^(?:faca)/i,
      /* 45: */  /^(?:\d*\.\d+)/i,
      /* 46: */  /^(?:[1-9]\d*|[0]+)/i,
